...
// Get all JDBC connections (prod and nonProd buckets) with auto-decrypt
router.get('/', (req, res) => {
  try {
    ...
    console.error('Error reading JDBC connections:', e);
    res.status(500).json({ error: 'Failed to read connections: ' + e.message });
  }
});
