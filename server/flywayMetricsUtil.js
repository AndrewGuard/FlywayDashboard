// Shared metrics calculation for Flyway Dashboard (backend, Node.js)
function calculateFlywayMetrics(flywayData, leadTimesData) {
...
module.exports = { calculateFlywayMetrics };