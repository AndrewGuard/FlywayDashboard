...
function addSampleLeadTimes() {
  ...
  // Create sample migrations with various lead times
  const today = new Date();
  const sampleMigrations = [
    {
      script: 'V100_20251201120000__feature_user_profile.sql',
      version: '100.20251201120000',
      scriptDate: new Date('2024-12-01T12:00:00Z').toISOString(), // 1 year ago
      deployDate: new Date('2024-12-15T14:30:00Z').toISOString(), // 14 days later
      leadTimeDays: 14.10,
    ...
    },
    {
      ...
      scriptDate: new Date('2024-11-10T09:00:00Z').toISOString(), // Script created
      deployDate: new Date('2024-11-17T16:00:00Z').toISOString(), // 7 days later
      leadTimeDays: 7.29,
    ...
    },
    {
      ...
      deployDate: new Date('2024-11-28T10:00:00Z').toISOString(), // 2.8 days later
      leadTimeDays: 2.81,
    ...
    },
    {
      ...
      deployDate: new Date('2024-12-10T15:00:00Z').toISOString(), // 5.2 days later
      leadTimeDays: 5.21,
    ...
    },
    {
      ...
      deployDate: new Date('2024-12-13T11:00:00Z').toISOString(), // 3.1 days later
      leadTimeDays: 3.13,
    ...
    },
    {
      ...
      deployDate: new Date('2024-12-14T09:00:00Z').toISOString(), // 1.7 days later
      leadTimeDays: 1.73,
